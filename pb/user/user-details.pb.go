...
type UserPhone struct {
	...
	IsWa   string `protobuf:"bytes,2,opt,name=is_wa,json=isWa,proto3" json:"is_wa,omitempty"`
}
...
func (x *UserPhone) GetIsWa() string {
	if x != nil {
		return x.IsWa
	}
	return ""
...
var file_pb_user_user_details_proto_rawDesc = []byte{
	...
	0x72, 0x12, 0x13, 0x0a, 0x05, 0x69, 0x73, 0x5f, 0x77, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
